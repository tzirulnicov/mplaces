...
var MultiBox = new Class({
	...
	showContent: function(){
		...
		this.contentContainer = new Element('div').setProperties({id: 'MultiBoxContentContainer'}).setStyles({cursor: 'pointer',opacity: 0, width: this.contentObj.width+'px', height: (Number(this.contentObj.height)+this.contentObj.xH)+'px'}).addEvent('click',this.next_click.bind(this)).injectInside(this.box);
		...
		this.number.setHTML(this.contentToLoad.number+' из '+this.content.length);
		if (this.options.descClassName) {
	...
	hideControls: function(num){
		this.controlEffects.start({'height': 0}).